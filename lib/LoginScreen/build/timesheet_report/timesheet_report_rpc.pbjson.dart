...
import 'timesheet_report.pbjson.dart' as $472;
import 'timesheet_report_request.pbjson.dart' as $473;
import 'timesheet_report_response.pbjson.dart' as $474;

const $core.Map<$core.String, $core.dynamic> TimesheetReportRpcServiceBase$json = {
  '1': 'TimesheetReportRpc',
  '2': [
    {'1': 'GetTimesheetReport', '2': '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseRequest', '3': '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseResponse'},
    {'1': 'GetTimesheetReportByAccountIdRequest', '2': '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseRequest', '3': '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseResponse'},
  ],
};

@$core.Deprecated('Use timesheetReportRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> TimesheetReportRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseRequest': $473.TimesheetReportBaseRequest$json,
  '.treeleaf.anydone.entities.pb.AuthRequest': $43.AuthRequest$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.GetTimesheetReportRequest': $473.GetTimesheetReportRequest$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportFilter': $473.TimesheetReportFilter$json,
  '.treeleaf.protos.DataQuery': $2.DataQuery$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.GetTimesheetReportByAccountIdRequest': $473.GetTimesheetReportByAccountIdRequest$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportBaseResponse': $474.TimesheetReportBaseResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.GetTimesheetReportResponse': $474.GetTimesheetReportResponse$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportList': $472.TimesheetReportList$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReport': $472.TimesheetReport$json,
  ...
  '.treeleaf.anydone.entities.pb.timesheet_report.GetTimesheetReportByAccountIdResponse': $474.GetTimesheetReportByAccountIdResponse$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportWithTicketsList': $472.TimesheetReportWithTicketsList$json,
  '.treeleaf.anydone.entities.pb.timesheet_report.TimesheetReportWithTickets': $472.TimesheetReportWithTickets$json,
...
/// Descriptor for `TimesheetReportRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List timesheetReportRpcServiceDescriptor = $convert.base64Decode(
    'ChJUaW1lc2hlZXRSZXBvcnRScGMSqwEKEkdldFRpbWVzaGVldFJlcG9ydBJJLnRyZWVsZWFmLm'
    'FueWRvbmUuZW50aXRpZXMucGIudGltZXNoZWV0X3JlcG9ydC5UaW1lc2hlZXRSZXBvcnRCYXNl'
    'UmVxdWVzdBpKLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIudGltZXNoZWV0X3JlcG9ydC'
    '5UaW1lc2hlZXRSZXBvcnRCYXNlUmVzcG9uc2USvQEKJEdldFRpbWVzaGVldFJlcG9ydEJ5QWNj'
    'b3VudElkUmVxdWVzdBJJLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIudGltZXNoZWV0X3'
    'JlcG9ydC5UaW1lc2hlZXRSZXBvcnRCYXNlUmVxdWVzdBpKLnRyZWVsZWFmLmFueWRvbmUuZW50'
    'aXRpZXMucGIudGltZXNoZWV0X3JlcG9ydC5UaW1lc2hlZXRSZXBvcnRCYXNlUmVzcG9uc2U=');
