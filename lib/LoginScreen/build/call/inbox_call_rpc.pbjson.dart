...
import 'inbox_call_req_res.pbjson.dart' as $316;

const $core.Map<$core.String, $core.dynamic> InboxCallRpcServiceBase$json = {
  '1': 'InboxCallRpc',
  '2': [
    {'1': 'inviteCallGuestParticipant', '2': '.treeleaf.anydone.entities.pb.call.CallInviteBaseRequest', '3': '.treeleaf.anydone.entities.pb.call.CallInviteBaseResponse', '4': {}},
    {'1': 'verifyCallGuestParticipant', '2': '.treeleaf.anydone.entities.pb.call.VerifyCallInviteBaseRequest', '3': '.treeleaf.anydone.entities.pb.call.VerifyCallInviteBaseResponse', '4': {}},
    {'1': 'getCallDetails', '2': '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseResponse', '4': {}},
    {'1': 'getGuestDetails', '2': '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseResponse', '4': {}},
  ],
};

@$core.Deprecated('Use inboxCallRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> InboxCallRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.call.CallInviteBaseRequest': $316.CallInviteBaseRequest$json,
  '.treeleaf.anydone.entities.pb.Request': $43.Request$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.pb.call.CallInviteRequest': $316.CallInviteRequest$json,
  '.treeleaf.anydone.entities.pb.call.CallInviteBaseResponse': $316.CallInviteBaseResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.pb.call.CallInviteResponse': $316.CallInviteResponse$json,
  '.treeleaf.anydone.entities.pb.call.VerifyCallInviteBaseRequest': $316.VerifyCallInviteBaseRequest$json,
  '.treeleaf.anydone.entities.pb.call.VerifyCallInviteRequest': $316.VerifyCallInviteRequest$json,
  '.treeleaf.anydone.entities.pb.call.VerifyCallInviteBaseResponse': $316.VerifyCallInviteBaseResponse$json,
  '.treeleaf.anydone.entities.pb.call.VerifyCallInviteResponse': $316.VerifyCallInviteResponse$json,
  '.treeleaf.anydone.entities.VerificationCodeLoginContext': $42.VerificationCodeLoginContext$json,
  '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseRequest': $316.GetCallDetailBaseRequest$json,
  '.treeleaf.anydone.entities.pb.call.GetCallDetailRequest': $316.GetCallDetailRequest$json,
  '.treeleaf.anydone.entities.pb.call.GetGuestDetailRequest': $316.GetGuestDetailRequest$json,
  '.treeleaf.anydone.entities.pb.call.GetCallDetailBaseResponse': $316.GetCallDetailBaseResponse$json,
  '.treeleaf.anydone.entities.pb.call.GetCallDetailResponse': $316.GetCallDetailResponse$json,
  ...
  '.treeleaf.anydone.entities.pb.call.GuestDetailResponse': $316.GuestDetailResponse$json,
};

/// Descriptor for `InboxCallRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List inboxCallRpcServiceDescriptor = $convert.base64Decode(
    'CgxJbmJveENhbGxScGMSkwEKGmludml0ZUNhbGxHdWVzdFBhcnRpY2lwYW50EjgudHJlZWxlYW'
    'YuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLkNhbGxJbnZpdGVCYXNlUmVxdWVzdBo5LnRyZWVs'
    'ZWFmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5DYWxsSW52aXRlQmFzZVJlc3BvbnNlIgASnw'
    'EKGnZlcmlmeUNhbGxHdWVzdFBhcnRpY2lwYW50Ej4udHJlZWxlYWYuYW55ZG9uZS5lbnRpdGll'
    'cy5wYi5jYWxsLlZlcmlmeUNhbGxJbnZpdGVCYXNlUmVxdWVzdBo/LnRyZWVsZWFmLmFueWRvbm'
    'UuZW50aXRpZXMucGIuY2FsbC5WZXJpZnlDYWxsSW52aXRlQmFzZVJlc3BvbnNlIgASjQEKDmdl'
    'dENhbGxEZXRhaWxzEjsudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLkdldENhbG'
    'xEZXRhaWxCYXNlUmVxdWVzdBo8LnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5H'
    'ZXRDYWxsRGV0YWlsQmFzZVJlc3BvbnNlIgASjgEKD2dldEd1ZXN0RGV0YWlscxI7LnRyZWVsZW'
    'FmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5HZXRDYWxsRGV0YWlsQmFzZVJlcXVlc3QaPC50'
    'cmVlbGVhZi5hbnlkb25lLmVudGl0aWVzLnBiLmNhbGwuR2V0Q2FsbERldGFpbEJhc2VSZXNwb2'
    '5zZSIA');
