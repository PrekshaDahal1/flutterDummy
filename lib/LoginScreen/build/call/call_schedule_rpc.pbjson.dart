...
import '../domain/call_schedule.pbjson.dart' as $407;
...
import 'call_schedule_request.pbjson.dart' as $408;
import 'call_schedule_response.pbjson.dart' as $409;

const $core.Map<$core.String, $core.dynamic> CallScheduleRpcServiceBase$json = {
  '1': 'CallScheduleRpc',
  '2': [
    {'1': 'CreateCallSchedule', '2': '.treeleaf.anydone.entities.pb.call.CreateCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.CreateCallScheduleResponse'},
    {'1': 'GetCallScheduleByInboxId', '2': '.treeleaf.anydone.entities.pb.call.GetCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallScheduleResponse'},
    {'1': 'UpdateCallScheduleById', '2': '.treeleaf.anydone.entities.pb.call.UpdateCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.UpdateCallScheduleResponse'},
    {'1': 'DeleteCallSchedule', '2': '.treeleaf.anydone.entities.pb.call.DeleteCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.DeleteCallScheduleResponse'},
    {'1': 'internal_GetScheduleByInboxId', '2': '.treeleaf.anydone.entities.pb.call.GetCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallScheduleResponse'},
    {'1': 'GetCallSchedule', '2': '.treeleaf.anydone.entities.pb.call.GetCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallScheduleResponse'},
    {'1': 'GetInboxCallScheduleById', '2': '.treeleaf.anydone.entities.pb.call.GetCallScheduleRequest', '3': '.treeleaf.anydone.entities.pb.call.GetCallScheduleResponse'},
  ],
};

@$core.Deprecated('Use callScheduleRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> CallScheduleRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.call.CreateCallScheduleRequest': $408.CreateCallScheduleRequest$json,
  '.treeleaf.anydone.entities.pb.Request': $43.Request$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.CallSchedule': $407.CallSchedule$json,
  ...
  '.treeleaf.anydone.entities.pb.call.CreateCallScheduleResponse': $409.CreateCallScheduleResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.pb.call.GetCallScheduleRequest': $408.GetCallScheduleRequest$json,
  '.treeleaf.anydone.entities.pb.call.GetCallScheduleResponse': $409.GetCallScheduleResponse$json,
  '.treeleaf.anydone.entities.pb.call.UpdateCallScheduleRequest': $408.UpdateCallScheduleRequest$json,
  '.treeleaf.anydone.entities.pb.call.UpdateCallScheduleResponse': $409.UpdateCallScheduleResponse$json,
  '.treeleaf.anydone.entities.pb.call.DeleteCallScheduleRequest': $408.DeleteCallScheduleRequest$json,
  '.treeleaf.anydone.entities.pb.call.DeleteCallScheduleResponse': $409.DeleteCallScheduleResponse$json,
};

/// Descriptor for `CallScheduleRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List callScheduleRpcServiceDescriptor = $convert.base64Decode(
    'Cg9DYWxsU2NoZWR1bGVScGMSkQEKEkNyZWF0ZUNhbGxTY2hlZHVsZRI8LnRyZWVsZWFmLmFueW'
    'RvbmUuZW50aXRpZXMucGIuY2FsbC5DcmVhdGVDYWxsU2NoZWR1bGVSZXF1ZXN0Gj0udHJlZWxl'
    'YWYuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLkNyZWF0ZUNhbGxTY2hlZHVsZVJlc3BvbnNlEp'
    'EBChhHZXRDYWxsU2NoZWR1bGVCeUluYm94SWQSOS50cmVlbGVhZi5hbnlkb25lLmVudGl0aWVz'
    'LnBiLmNhbGwuR2V0Q2FsbFNjaGVkdWxlUmVxdWVzdBo6LnRyZWVsZWFmLmFueWRvbmUuZW50aX'
    'RpZXMucGIuY2FsbC5HZXRDYWxsU2NoZWR1bGVSZXNwb25zZRKVAQoWVXBkYXRlQ2FsbFNjaGVk'
    'dWxlQnlJZBI8LnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5VcGRhdGVDYWxsU2'
    'NoZWR1bGVSZXF1ZXN0Gj0udHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLlVwZGF0'
    'ZUNhbGxTY2hlZHVsZVJlc3BvbnNlEpEBChJEZWxldGVDYWxsU2NoZWR1bGUSPC50cmVlbGVhZi'
    '5hbnlkb25lLmVudGl0aWVzLnBiLmNhbGwuRGVsZXRlQ2FsbFNjaGVkdWxlUmVxdWVzdBo9LnRy'
    'ZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5EZWxldGVDYWxsU2NoZWR1bGVSZXNwb2'
    '5zZRKWAQodaW50ZXJuYWxfR2V0U2NoZWR1bGVCeUluYm94SWQSOS50cmVlbGVhZi5hbnlkb25l'
    'LmVudGl0aWVzLnBiLmNhbGwuR2V0Q2FsbFNjaGVkdWxlUmVxdWVzdBo6LnRyZWVsZWFmLmFueW'
    'RvbmUuZW50aXRpZXMucGIuY2FsbC5HZXRDYWxsU2NoZWR1bGVSZXNwb25zZRKIAQoPR2V0Q2Fs'
    'bFNjaGVkdWxlEjkudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLkdldENhbGxTY2'
    'hlZHVsZVJlcXVlc3QaOi50cmVlbGVhZi5hbnlkb25lLmVudGl0aWVzLnBiLmNhbGwuR2V0Q2Fs'
    'bFNjaGVkdWxlUmVzcG9uc2USkQEKGEdldEluYm94Q2FsbFNjaGVkdWxlQnlJZBI5LnRyZWVsZW'
    'FmLmFueWRvbmUuZW50aXRpZXMucGIuY2FsbC5HZXRDYWxsU2NoZWR1bGVSZXF1ZXN0GjoudHJl'
    'ZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5jYWxsLkdldENhbGxTY2hlZHVsZVJlc3BvbnNl');
