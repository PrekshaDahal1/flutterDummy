...
import 'bugreport_request.pbjson.dart' as $206;
import 'bugreport_response.pbjson.dart' as $207;

const $core.Map<$core.String, $core.dynamic> BugReportRpcServiceBase$json = {
  '1': 'BugReportRpc',
  '2': [
    {'1': 'createBugReport', '2': '.treeleaf.anydone.entities.pb.bugreport.BugReportRequest', '3': '.treeleaf.anydone.entities.pb.bugreport.BugReportResponse'},
  ],
};

@$core.Deprecated('Use bugReportRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> BugReportRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.bugreport.BugReportRequest': $206.BugReportRequest$json,
  ...
  '.treeleaf.anydone.entities.pb.bugreport.BugReportResponse': $207.BugReportResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
};

/// Descriptor for `BugReportRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List bugReportRpcServiceDescriptor = $convert.base64Decode(
    'CgxCdWdSZXBvcnRScGMShgEKD2NyZWF0ZUJ1Z1JlcG9ydBI4LnRyZWVsZWFmLmFueWRvbmUuZW'
    '50aXRpZXMucGIuYnVncmVwb3J0LkJ1Z1JlcG9ydFJlcXVlc3QaOS50cmVlbGVhZi5hbnlkb25l'
    'LmVudGl0aWVzLnBiLmJ1Z3JlcG9ydC5CdWdSZXBvcnRSZXNwb25zZQ==');
