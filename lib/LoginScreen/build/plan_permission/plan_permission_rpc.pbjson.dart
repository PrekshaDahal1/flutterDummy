...
import 'plan_permission_request.pbjson.dart' as $253;
import 'plan_permission_response.pbjson.dart' as $254;

const $core.Map<$core.String, $core.dynamic> PlanPermissionRpcServiceBase$json = {
  '1': 'PlanPermissionRpc',
  '2': [
    {'1': 'AuthorizePlanPermission', '2': '.treeleaf.anydone.entities.pb.pricingplan.AuthorizePlanPermissionRequest', '3': '.treeleaf.anydone.entities.pb.pricingplan.AuthorizePlanPermissionResponse'},
  ],
};

@$core.Deprecated('Use planPermissionRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> PlanPermissionRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.pricingplan.AuthorizePlanPermissionRequest': $253.AuthorizePlanPermissionRequest$json,
  ...
  '.treeleaf.anydone.entities.pb.pricingplan.AuthorizePlanPermissionResponse': $254.AuthorizePlanPermissionResponse$json,
...
/// Descriptor for `PlanPermissionRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List planPermissionRpcServiceDescriptor = $convert.base64Decode(
    'ChFQbGFuUGVybWlzc2lvblJwYxKuAQoXQXV0aG9yaXplUGxhblBlcm1pc3Npb24SSC50cmVlbG'
    'VhZi5hbnlkb25lLmVudGl0aWVzLnBiLnByaWNpbmdwbGFuLkF1dGhvcml6ZVBsYW5QZXJtaXNz'
    'aW9uUmVxdWVzdBpJLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIucHJpY2luZ3BsYW4uQX'
    'V0aG9yaXplUGxhblBlcm1pc3Npb25SZXNwb25zZQ==');
