...
import 'crm_ticket_query_request.pbjson.dart' as $521;
import 'crm_ticket_query_response.pbjson.dart' as $522;

const $core.Map<$core.String, $core.dynamic> CRMTicketQueryRpcServiceBase$json = {
  '1': 'CRMTicketQueryRpc',
  '2': [
    {'1': 'GetTicketByConversationGroupId', '2': '.treeleaf.anydone.entities.CRMTicketQueryBaseRequest', '3': '.treeleaf.anydone.entities.CRMTicketQueryBaseResponse'},
  ],
};

@$core.Deprecated('Use cRMTicketQueryRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> CRMTicketQueryRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.CRMTicketQueryBaseRequest': $521.CRMTicketQueryBaseRequest$json,
  '.treeleaf.anydone.entities.pb.AuthRequest': $43.AuthRequest$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.GetCRMTicketByConversationGroupIdRequest': $521.GetCRMTicketByConversationGroupIdRequest$json,
  '.treeleaf.protos.DataQuery': $2.DataQuery$json,
  '.treeleaf.anydone.entities.CRMTicketQueryBaseResponse': $522.CRMTicketQueryBaseResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.GetCRMTicketByConversationGroupIdResponse': $522.GetCRMTicketByConversationGroupIdResponse$json,
...
/// Descriptor for `CRMTicketQueryRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List cRMTicketQueryRpcServiceDescriptor = $convert.base64Decode(
    'ChFDUk1UaWNrZXRRdWVyeVJwYxKNAQoeR2V0VGlja2V0QnlDb252ZXJzYXRpb25Hcm91cElkEj'
    'QudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5DUk1UaWNrZXRRdWVyeUJhc2VSZXF1ZXN0GjUu'
    'dHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5DUk1UaWNrZXRRdWVyeUJhc2VSZXNwb25zZQ==');
