...
const $core.Map<$core.String, $core.dynamic> AIAgentInputResolverRpcServiceBase$json = {
  '1': 'AIAgentInputResolverRpc',
  '2': [
    {'1': 'GetResolvedInput', '2': '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentInputResolverBaseRequest', '3': '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentInputResolverBaseResponse'},
    {'1': 'DecideInput', '2': '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputBaseRequest', '3': '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputBaseResponse'},
  ],
};

@$core.Deprecated('Use aIAgentInputResolverRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> AIAgentInputResolverRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentInputResolverBaseRequest': $321.AIAgentInputResolverBaseRequest$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputDetail': $320.AIAgentTriggerInputDetail$json,
  ...
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputMeta': $320.AIAgentTriggerInputMeta$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputUserMeta': $320.AIAgentTriggerInputUserMeta$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputLanguageMeta': $320.AIAgentTriggerInputLanguageMeta$json,
  ...
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputQueryRequest': $320.AIAgentTriggerInputQueryRequest$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentTriggerInputQueryResponse': $320.AIAgentTriggerInputQueryResponse$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentInputResolverBaseResponse': $321.AIAgentInputResolverBaseResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.AIAgentInputResolverResponse': $320.AIAgentInputResolverResponse$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputBaseRequest': $321.DecideTriggerInputBaseRequest$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputRequest': $320.DecideTriggerInputRequest$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputBaseResponse': $321.DecideTriggerInputBaseResponse$json,
  '.treeleaf.anydone.entities.pb.ai_agent.input.resolver.DecideTriggerInputResponse': $320.DecideTriggerInputResponse$json,
};

/// Descriptor for `AIAgentInputResolverRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List aIAgentInputResolverRpcServiceDescriptor = $convert.base64Decode(
    'ChdBSUFnZW50SW5wdXRSZXNvbHZlclJwYxLBAQoQR2V0UmVzb2x2ZWRJbnB1dBJVLnRyZWVsZW'
    'FmLmFueWRvbmUuZW50aXRpZXMucGIuYWlfYWdlbnQuaW5wdXQucmVzb2x2ZXIuQUlBZ2VudElu'
    'cHV0UmVzb2x2ZXJCYXNlUmVxdWVzdBpWLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuYW'
    'lfYWdlbnQuaW5wdXQucmVzb2x2ZXIuQUlBZ2VudElucHV0UmVzb2x2ZXJCYXNlUmVzcG9uc2US'
    'uAEKC0RlY2lkZUlucHV0ElMudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5haV9hZ2VudC'
    '5pbnB1dC5yZXNvbHZlci5EZWNpZGVUcmlnZ2VySW5wdXRCYXNlUmVxdWVzdBpULnRyZWVsZWFm'
    'LmFueWRvbmUuZW50aXRpZXMucGIuYWlfYWdlbnQuaW5wdXQucmVzb2x2ZXIuRGVjaWRlVHJpZ2'
    'dlcklucHV0QmFzZVJlc3BvbnNl');
