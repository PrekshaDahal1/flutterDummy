...
const $core.Map<$core.String, $core.dynamic> AppFileRpcServiceBase$json = {
  '1': 'AppFileRpc',
  '2': [
    {'1': 'internal_getAppFiles', '2': '.treeleaf.anydone.entities.pb.app.GetAppFileRequest', '3': '.treeleaf.anydone.entities.pb.app.AppDetailResponse'},
  ],
};

@$core.Deprecated('Use appFileRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> AppFileRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.app.GetAppFileRequest': $194.GetAppFileRequest$json,
...
/// Descriptor for `AppFileRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List appFileRpcServiceDescriptor = $convert.base64Decode(
    'CgpBcHBGaWxlUnBjEoABChRpbnRlcm5hbF9nZXRBcHBGaWxlcxIzLnRyZWVsZWFmLmFueWRvbm'
    'UuZW50aXRpZXMucGIuYXBwLkdldEFwcEZpbGVSZXF1ZXN0GjMudHJlZWxlYWYuYW55ZG9uZS5l'
    'bnRpdGllcy5wYi5hcHAuQXBwRGV0YWlsUmVzcG9uc2U=');
