...
import 'add_app_webhook_request.pbjson.dart' as $198;
import 'add_app_webhook_response.pbjson.dart' as $199;

const $core.Map<$core.String, $core.dynamic> AddAppWebhookRpcServiceBase$json = {
  '1': 'AddAppWebhookRpc',
  '2': [
    {'1': 'addAppWebhook', '2': '.treeleaf.anydone.entities.pb.app.AddAppWebhookRequest', '3': '.treeleaf.anydone.entities.pb.app.AddAppWebhookResponse'},
  ],
};

@$core.Deprecated('Use addAppWebhookRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> AddAppWebhookRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.app.AddAppWebhookRequest': $198.AddAppWebhookRequest$json,
  ...
  '.treeleaf.anydone.entities.pb.app.AddAppWebhookResponse': $199.AddAppWebhookResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
};

/// Descriptor for `AddAppWebhookRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List addAppWebhookRpcServiceDescriptor = $convert.base64Decode(
    'ChBBZGRBcHBXZWJob29rUnBjEoABCg1hZGRBcHBXZWJob29rEjYudHJlZWxlYWYuYW55ZG9uZS'
    '5lbnRpdGllcy5wYi5hcHAuQWRkQXBwV2ViaG9va1JlcXVlc3QaNy50cmVlbGVhZi5hbnlkb25l'
    'LmVudGl0aWVzLnBiLmFwcC5BZGRBcHBXZWJob29rUmVzcG9uc2U=');
