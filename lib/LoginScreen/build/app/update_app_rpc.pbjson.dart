...
import 'update_app_request.pbjson.dart' as $202;
import 'update_app_response.pbjson.dart' as $203;

const $core.Map<$core.String, $core.dynamic> UpdateAppRpcServiceBase$json = {
  '1': 'UpdateAppRpc',
  '2': [
    {'1': 'enableEmployeeApp', '2': '.treeleaf.anydone.entities.pb.app.UpdateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.UpdateAppResponse'},
    {'1': 'regenerateSecret', '2': '.treeleaf.anydone.entities.pb.app.UpdateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.UpdateAppResponse'},
    {'1': 'updateWebhookStatus', '2': '.treeleaf.anydone.entities.pb.app.UpdateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.UpdateAppResponse'},
    {'1': 'checkAppInstallationStatus', '2': '.treeleaf.anydone.entities.pb.app.UpdateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.UpdateAppResponse'},
  ],
};

@$core.Deprecated('Use updateAppRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> UpdateAppRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.app.UpdateAppRequest': $202.UpdateAppRequest$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.pb.app.UpdateAppResponse': $203.UpdateAppResponse$json,
...
/// Descriptor for `UpdateAppRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List updateAppRpcServiceDescriptor = $convert.base64Decode(
    'CgxVcGRhdGVBcHBScGMSfAoRZW5hYmxlRW1wbG95ZWVBcHASMi50cmVlbGVhZi5hbnlkb25lLm'
    'VudGl0aWVzLnBiLmFwcC5VcGRhdGVBcHBSZXF1ZXN0GjMudHJlZWxlYWYuYW55ZG9uZS5lbnRp'
    'dGllcy5wYi5hcHAuVXBkYXRlQXBwUmVzcG9uc2USewoQcmVnZW5lcmF0ZVNlY3JldBIyLnRyZW'
    'VsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuYXBwLlVwZGF0ZUFwcFJlcXVlc3QaMy50cmVlbGVh'
    'Zi5hbnlkb25lLmVudGl0aWVzLnBiLmFwcC5VcGRhdGVBcHBSZXNwb25zZRJ+ChN1cGRhdGVXZW'
    'Job29rU3RhdHVzEjIudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5hcHAuVXBkYXRlQXBw'
    'UmVxdWVzdBozLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuYXBwLlVwZGF0ZUFwcFJlc3'
    'BvbnNlEoUBChpjaGVja0FwcEluc3RhbGxhdGlvblN0YXR1cxIyLnRyZWVsZWFmLmFueWRvbmUu'
    'ZW50aXRpZXMucGIuYXBwLlVwZGF0ZUFwcFJlcXVlc3QaMy50cmVlbGVhZi5hbnlkb25lLmVudG'
    'l0aWVzLnBiLmFwcC5VcGRhdGVBcHBSZXNwb25zZQ==');
