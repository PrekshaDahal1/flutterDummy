...
import 'create_app_request.pbjson.dart' as $196;
import 'create_app_response.pbjson.dart' as $197;

const $core.Map<$core.String, $core.dynamic> CreateAppRpcServiceBase$json = {
  '1': 'CreateAppRpc',
  '2': [
    {'1': 'configureAppForEmployee', '2': '.treeleaf.anydone.entities.pb.app.CreateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.CreateAppResponse'},
    {'1': 'addAppToAnydone', '2': '.treeleaf.anydone.entities.pb.app.CreateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.CreateAppResponse'},
    {'1': 'createAnydoneApp', '2': '.treeleaf.anydone.entities.pb.app.CreateAppRequest', '3': '.treeleaf.anydone.entities.pb.app.CreateAppResponse'},
  ],
};

@$core.Deprecated('Use createAppRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> CreateAppRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.app.CreateAppRequest': $196.CreateAppRequest$json,
  ...
  '.treeleaf.anydone.entities.pb.app.CreateAppResponse': $197.CreateAppResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
};

/// Descriptor for `CreateAppRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List createAppRpcServiceDescriptor = $convert.base64Decode(
    'CgxDcmVhdGVBcHBScGMSggEKF2NvbmZpZ3VyZUFwcEZvckVtcGxveWVlEjIudHJlZWxlYWYuYW'
    '55ZG9uZS5lbnRpdGllcy5wYi5hcHAuQ3JlYXRlQXBwUmVxdWVzdBozLnRyZWVsZWFmLmFueWRv'
    'bmUuZW50aXRpZXMucGIuYXBwLkNyZWF0ZUFwcFJlc3BvbnNlEnoKD2FkZEFwcFRvQW55ZG9uZR'
    'IyLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuYXBwLkNyZWF0ZUFwcFJlcXVlc3QaMy50'
    'cmVlbGVhZi5hbnlkb25lLmVudGl0aWVzLnBiLmFwcC5DcmVhdGVBcHBSZXNwb25zZRJ7ChBjcm'
    'VhdGVBbnlkb25lQXBwEjIudHJlZWxlYWYuYW55ZG9uZS5lbnRpdGllcy5wYi5hcHAuQ3JlYXRl'
    'QXBwUmVxdWVzdBozLnRyZWVsZWFmLmFueWRvbmUuZW50aXRpZXMucGIuYXBwLkNyZWF0ZUFwcF'
    'Jlc3BvbnNl');
