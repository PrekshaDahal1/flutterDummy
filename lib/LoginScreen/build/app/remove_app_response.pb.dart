...
//  source: app/remove_app_response.proto
//
// @dart = 2.12
...
class RemoveAppResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoveAppResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'treeleaf.anydone.entities.pb.app'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  RemoveAppResponse copyWith(void Function(RemoveAppResponse) updates) => super.copyWith((message) => updates(message as RemoveAppResponse)) as RemoveAppResponse;
