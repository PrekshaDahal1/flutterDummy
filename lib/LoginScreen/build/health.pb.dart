...
class HealthApi {
  ...
  $async.Future<HealthCheckResponse> check_($pb.ClientContext? ctx, HealthCheckRequest request) =>
    _client.invoke<HealthCheckResponse>(ctx, 'Health', 'Check', request, HealthCheckResponse())
  ;
  $async.Future<HealthCheckResponse> watch($pb.ClientContext? ctx, HealthCheckRequest request) =>
    _client.invoke<HealthCheckResponse>(ctx, 'Health', 'Watch', request, HealthCheckResponse())
  ;
}
