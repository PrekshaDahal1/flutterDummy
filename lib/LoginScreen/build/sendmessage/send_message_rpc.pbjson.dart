...
import 'send_message_request.pbjson.dart' as $529;
import 'send_message_response.pbjson.dart' as $530;

const $core.Map<$core.String, $core.dynamic> SendMessageRpcServiceBase$json = {
  '1': 'SendMessageRpc',
  '2': [
    {'1': 'internal_SendMessage', '2': '.treeleaf.anydone.entities.pb.sendmessage.SendMessageRequest', '3': '.treeleaf.anydone.entities.pb.sendmessage.SendMessageResponse'},
  ],
};

@$core.Deprecated('Use sendMessageRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> SendMessageRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.sendmessage.SendMessageRequest': $529.SendMessageRequest$json,
  ...
  '.treeleaf.anydone.entities.pb.sendmessage.SendMessageResponse': $530.SendMessageResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
};

/// Descriptor for `SendMessageRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List sendMessageRpcServiceDescriptor = $convert.base64Decode(
    'Cg5TZW5kTWVzc2FnZVJwYxKTAQoUaW50ZXJuYWxfU2VuZE1lc3NhZ2USPC50cmVlbGVhZi5hbn'
    'lkb25lLmVudGl0aWVzLnBiLnNlbmRtZXNzYWdlLlNlbmRNZXNzYWdlUmVxdWVzdBo9LnRyZWVs'
    'ZWFmLmFueWRvbmUuZW50aXRpZXMucGIuc2VuZG1lc3NhZ2UuU2VuZE1lc3NhZ2VSZXNwb25zZQ'
    '==');
