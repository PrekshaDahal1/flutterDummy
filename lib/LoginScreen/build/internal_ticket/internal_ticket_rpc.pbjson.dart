...
import 'internal_ticket_request.pbjson.dart' as $204;
import 'internal_ticket_response.pbjson.dart' as $205;

const $core.Map<$core.String, $core.dynamic> InternalTicketServiceRpcServiceBase$json = {
  '1': 'InternalTicketServiceRpc',
  '2': [
    {'1': 'InternalUpdateTicketFlowcessOutput', '2': '.treeleaf.anydone.entities.pb.UpdateTicketFlowcessOutputBaseRequest', '3': '.treeleaf.anydone.entities.pb.UpdateTicketFlowcessOutputBaseResponse'},
  ],
};

@$core.Deprecated('Use internalTicketServiceRpcServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> InternalTicketServiceRpcServiceBase$messageJson = {
  '.treeleaf.anydone.entities.pb.UpdateTicketFlowcessOutputBaseRequest': $204.UpdateTicketFlowcessOutputBaseRequest$json,
  '.treeleaf.anydone.entities.pb.AuthRequest': $43.AuthRequest$json,
  '.treeleaf.anydone.entities.Authorization': $42.Authorization$json,
  '.treeleaf.protos.Debug': $2.Debug$json,
  '.treeleaf.anydone.entities.pb.UpdateFlowcessOutputRequest': $204.UpdateFlowcessOutputRequest$json,
  '.treeleaf.anydone.entities.pb.UpdateTicketFlowcessOutputBaseResponse': $205.UpdateTicketFlowcessOutputBaseResponse$json,
  '.treeleaf.anydone.entities.pb.Response': $45.Response$json,
  '.treeleaf.anydone.entities.pb.UpdateFlowcessOutputResponse': $205.UpdateFlowcessOutputResponse$json,
...
/// Descriptor for `InternalTicketServiceRpc`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List internalTicketServiceRpcServiceDescriptor = $convert.base64Decode(
    'ChhJbnRlcm5hbFRpY2tldFNlcnZpY2VScGMSrwEKIkludGVybmFsVXBkYXRlVGlja2V0Rmxvd2'
    'Nlc3NPdXRwdXQSQy50cmVlbGVhZi5hbnlkb25lLmVudGl0aWVzLnBiLlVwZGF0ZVRpY2tldEZs'
    'b3djZXNzT3V0cHV0QmFzZVJlcXVlc3QaRC50cmVlbGVhZi5hbnlkb25lLmVudGl0aWVzLnBiLl'
    'VwZGF0ZVRpY2tldEZsb3djZXNzT3V0cHV0QmFzZVJlc3BvbnNl');
